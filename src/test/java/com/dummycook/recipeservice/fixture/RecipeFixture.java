...
public class RecipeFixture {
    ...
    public Recipe generateRecipe(RecipeName name) {
        Recipe recipe = new Recipe();
        String recipeName = null;
        String instructions = null;
        int numberOfServings = 0;
        Set<RecipeIngredient> ingredientSet = new HashSet<>(0);
        switch (name) {
            case SPAGHETTI:
    ...
    RecipeIngredient generateRecipeIngredient(Double amount, String unityOfMeasure, String ingredientName) {
