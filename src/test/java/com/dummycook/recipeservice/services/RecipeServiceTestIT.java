...
class RecipeServiceTestIT {
    ...
    private Recipe getOrCreateRecipe(String name) {
        ...
        if (BRUSCHETTA_TITLE.equals(name)) {
            ...
            ingredientSet3.add(fixture.generateRecipeIngredient(recipeBruschettaDto, 0.5, "cup", "chopped basil leaves"));
            ingredientSet3.add(fixture.generateRecipeIngredient(recipeBruschettaDto, 0.3, "cup", "Diced red onion"));
            ingredientSet3.add(fixture.generateRecipeIngredient(recipeBruschettaDto, 2.0, "tbsp", "Olive oil"));
